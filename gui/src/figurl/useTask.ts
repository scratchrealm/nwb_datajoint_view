...
const useTask = <ReturnType>(functionId: TaskFunctionId | string | undefined, kwargs: TaskKwargs | {[key: string]: any}, functionType: TaskFunctionType, opts: {queryUseCache?: boolean, queryFallbackToCache?: boolean}): {returnValue?: ReturnType, task?: Task<ReturnType>, refresh: () => void} => {
    ...
    }, [functionId, kwargsString, refreshCode, functionType, incrementUpdateCode, opts.queryUseCache, opts.queryFallbackToCache])
